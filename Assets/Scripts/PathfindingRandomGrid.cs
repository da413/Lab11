...
public class PathfindingRandomGrid : MonoBehaviour
{
    ...
    [SerializeField] private float obstacleProbability = 30f;
    ...
    private void Start()
    {
        GenerateRandomGrid(grid.GetLength(1), grid.GetLength(0), obstacleProbability);
    }
